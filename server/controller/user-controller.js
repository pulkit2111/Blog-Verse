...
export const googleCallback= async(req,res)=>{
    ...
    res.redirect(`https://main--bloggverse.netlify.app/google-callback?accessToken=${accessToken}&refreshToken=${refreshToken}&email=${user.email}&name=${user.name}&picture=${user.picture}`);
}
